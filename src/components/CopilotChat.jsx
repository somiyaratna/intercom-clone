...
export default function CopilotChat() {
  return (
    <div className="flex flex-col flex-grow justify-center items-center w-full px-4">
      ...
      <div className="flex items-center gap-2 my-6 rounded-lg bg-[#fcfcfc] mt-auto w-full ">
        <textarea
          name="copilot"
          id="copilot-question"
          placeholder="Ask a question..."
          className="flex resize-none w-full h-16 md:h-10 border-none outline-none border px-3 py-1 md:py-2 placeholder:text-xs lg:placeholder:text-sm overflow-y-scroll scrollbar-hide"
        ></textarea>
